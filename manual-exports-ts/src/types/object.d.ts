...
import { AssetBundle } from "./behaviors/assetbundle";
import { Book } from "./behaviors/book";
import { Browser } from "./behaviors/browser";
import { Clock } from "./behaviors/clock";
import { Counter } from "./behaviors/counter";
import { LayoutZone } from "./behaviors/layoutzone";
import { RPGFigurine } from "./behaviors/rpgfigurine";
import { TextTool } from "./behaviors/texttool";
import { SpawnObjectDataParameters } from "./base";
...
export interface GObject {
  ...
  setRotationValue(
    this: void,
    rotation_value: Vector | number | string
  ): boolean;
