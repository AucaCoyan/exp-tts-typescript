 ...
 * @returns {GObject}
 */
export declare function getObjectFromGUID(guid: string): GObject;
...
declare function spawnObjectData(
  parameters: SpawnObjectDataParameters
): GObject;
...
declare function spawnObjectJSON(
  parameters: SpawnObjectJSONParameters
): GObject;
 ...
 */
export type SpawnObjectDataParameters = {
  data: any;
  position?: Vector;
  rotation?: Vector;
  scale?: Vector;
